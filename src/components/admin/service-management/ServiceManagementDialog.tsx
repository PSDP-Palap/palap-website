...
interface ServiceManagementDialogProps {
  ...
  onClose: () => void;
  onUpdate: (id: string, data: Partial<Omit<Service, "service_id">>) => Promise<void>;
...
export const ServiceManagementDialog = ({
  ...
  const [previewUrl, setPreviewUrl] = useState<string>(service?.image_url || "");
        ...
        <div className="p-8">
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
              ...
              <p className="text-xs font-mono text-gray-500 break-all">{service.service_id}</p>
            </div>
            ...
            {!isEditing ? (
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="border-b border-gray-50 pb-2">
                    ...
                    <p className="font-black text-[#A6411C] text-lg">{service.price.toLocaleString()} ฿</p>
                  </div>
                </div>
                ...
                <div className="border-b border-gray-50 pb-2">
                  ...
                  <p className="text-sm text-gray-700 whitespace-pre-wrap">{service.detail_1 || "-"}</p>
                </div>

                <div className="border-b border-gray-50 pb-2">
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block mb-1">Detail 2</label>
                  <p className="text-sm text-gray-700 whitespace-pre-wrap">{service.detail_2 || "-"}</p>
                </div>
              ...
              <form onSubmit={handleUpdate} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent position="popper" sideOffset={4} className="z-80">
                ...
                <div>
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block mb-1">Detail 1</label>
                  <textarea name="detail_1" value={form.detail_1 || ""} onChange={handleChange} className="w-full border border-gray-100 bg-gray-50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 min-h-[80px]" />
                </div>

                <div>
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block mb-1">Detail 2</label>
                  <textarea name="detail_2" value={form.detail_2 || ""} onChange={handleChange} className="w-full border border-gray-100 bg-gray-50 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 min-h-[80px]" />
                </div>
